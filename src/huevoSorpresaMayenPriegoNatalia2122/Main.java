...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        HuevoSorpresaMayenPriegoNatalia2122 h_sorpresa;
       
        
        h_sorpresa=new HuevoSorpresaMayenPriegoNatalia2122(10,5,"peluche",10);
        opera_PrecioMayenPriegoNatalia2122(h_sorpresa);
        
        opera_UnidadesMayenPriegoNatalia2122(h_sorpresa);
        
    }

    public static void opera_UnidadesMayenPriegoNatalia2122(HuevoSorpresaMayenPriegoNatalia2122 h_sorpresa) {
    ...
    public static void opera_PrecioMayenPriegoNatalia2122(HuevoSorpresaMayenPriegoNatalia2122 h_sorpresa) {
